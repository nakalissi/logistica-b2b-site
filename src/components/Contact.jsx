...
const CONTACT_INFO = [
  {
    icon: '📧',
    label: 'E-mail',
    value: 'contato@logisticab2b.com.br',
    href: 'mailto:contato@logisticab2b.com.br',
  },
  {
    icon: '📞',
    label: 'Telefone / WhatsApp',
    value: '(11) 97281-4543',
    href: 'https://wa.me/5511972814543',
  },
  {
    icon: '🌐',
    label: 'Site',
    value: 'www.logisticab2b.com.br',
    href: 'https://www.logisticab2b.com.br',
  },
  {
    icon: '🕒',
    label: 'Atendimento',
